...
const SideBarDrawer = ({
  ...
  return (
    <div
      ...
      <div
        id='sidebar-drawer'
        className={`z-50 w-[90vw] ${className} ${
          isOpen ? 'translate-x-0 opacity-100' : 'translate-x-[-100%] opacity-0'
        } transform transition-transform duration-300 ease-in-out bg-white dark:bg-gray-900 flex flex-col fixed h-full left-0 overflow-y-scroll top-0 max-w-[280px]`}>
        {children}
      </div>
